...
--
-- Host: localhost    Database: mobRep
-- ------------------------------------------------------
...
CREATE TABLE `customer` (
  ...
  CONSTRAINT `Customer_staffID` FOREIGN KEY (`staffID`) REFERENCES `staff` (`staffID`) ON DELETE CASCADE
...
INSERT INTO `fixes` VALUES ('145236521458798',1,'moin'),('156895478512456',3,'john');
...
CREATE TABLE `gives` (
  ...
  CONSTRAINT `Gives_customerID` FOREIGN KEY (`customerID`) REFERENCES `customer` (`customerID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `gives` VALUES (100,'156895478512456','2021-01-23','bb100'),(101,'145236521458798','2021-01-26','mb101'),(102,'154856954785214','2021-01-01','sc102'),(103,'158796548524695','2021-01-04','jh103'),(104,'178546953256485','2021-02-04','lj104');
...
INSERT INTO `issue` VALUES ('145236521458798','Hardware','Faulty motherboard','','yes','10 Days'),('156895478512456','Hardware','Broken LCD','200','yes','2 Days'),('178546953256485','Software','Jail break','50','yes','1 Hour');
...
INSERT INTO `use` VALUES (1000,1,'T-MOR'),(1001,1,'MyBat'),(1002,1,'SAMSUNG'),(1003,1,'SAMSUNG'),(1004,1,'SAMSUNG LCD'),(1004,2,'SAMSUNG LCD'),(1004,3,'SAMSUNG LCD');
...
-- Dump completed on 2021-04-18 21:01:23
